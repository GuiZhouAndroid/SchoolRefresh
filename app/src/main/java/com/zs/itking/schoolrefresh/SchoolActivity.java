...
import com.zs.itking.schoolrefresh.adapter.BaseRecyclerAdapter;
import com.zs.itking.schoolrefresh.adapter.SmartViewHolder;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (Item.values()[position % Item.values().length]) {
            ...
            case 展开:
                ...
                break;
            case 蓝色主题:
                StatusBarUtils.setThemeColor(this, R.color.colorPrimary, R.color.colorPrimaryDark, mToolbar, mToolbarLayout, mAppBarLayout, mRefreshLayout, mActionButton);
                break;
            case 绿色主题:
                StatusBarUtils.setThemeColor(this, android.R.color.holo_green_light, android.R.color.holo_green_dark, mToolbar, mToolbarLayout, mAppBarLayout, mRefreshLayout, mActionButton);

                break;
            case 红色主题:
                StatusBarUtils.setThemeColor(this, android.R.color.holo_red_light, android.R.color.holo_red_dark, mToolbar, mToolbarLayout, mAppBarLayout, mRefreshLayout, mActionButton);

                break;
            case 橙色主题:
                StatusBarUtils.setThemeColor(this, android.R.color.holo_orange_light, android.R.color.holo_orange_dark, mToolbar, mToolbarLayout, mAppBarLayout, mRefreshLayout, mActionButton);
